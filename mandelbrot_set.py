# -*- coding: utf-8 -*-
"""
Created on Mon Oct 26 14:43:13 2020

@author: boucher
"""
# thanks to Vladimir Ilievski's post on matplotblog (matplotlib's blog)
...
anim = animation.FuncAnimation(fig, animate, frames=85, interval=120, blit=True)
